...
@section('page_title', 'Laporan Pengajuan Barang & ATK')
...
<div class="relative overflow-x-auto pb-10">
    ...
    <div class="flex items-center justify-between mb-3">
        <div class="text-sm">
            ...
            <a href="{{ route('stuffs.report') }}" class="text-sm text-blue-400">
                [ Clear Search ]
            </a>
        </div>
    </div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        {{ str_pad($stuff->no, 3, '0', STR_PAD_LEFT) }}/RE/IT/{{
                        $stuff->created_at->format('Y') }}
                    </td>
                    <td class="px-6 py-4">
