...
@section('page_title', $reimbursement->code . ' - Lampiran')
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('reimbursement-attachments.store', $reimbursement->id) }}"
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td scope="col" class="px-6 py-3">
                <div class="flex items-center gap-1">
                    ...
                    <form action="{{ route('reimbursement-attachments.destroy', $attachment->id) }}" method="POST"
