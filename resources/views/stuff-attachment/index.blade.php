...
@section('page_title', $stuff->code . ' - Lampiran')
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('stuff-attachments.store', $stuff->id) }}" method="POST"
...
<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody id="items-container">
        @foreach ($stuff->attachments as $attachment)
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td scope="col" class="px-6 py-3">
                <div class="flex items-center gap-1">
                    ...
                    <form action="{{ route('stuff-attachments.destroy', $attachment->id) }}" method="POST"
