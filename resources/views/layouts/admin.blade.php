                ...
                <div class="flex items-center ms-3">
                    <div class="flex gap-3 items-center">
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="{{ asset('images/logo_hma.png') }}" alt="user photo">
                        </button>
                        @if (auth()->user()->role_id === Database\Seeders\RoleSeeder::ADMIN_ID)
                        <svg data-tooltip-target="role-note" class="w-6 h-6 text-blue-600" aria-hidden="true"
...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @if (auth()->user()->role_id === Database\Seeders\RoleSeeder::ADMIN_ID)
            <li>
                <a href="{{ route('cash-advances.report')  }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Laporan Pengajuan</span>
                </a>
            </li>
            @endif
            <li>
            ...
            <li>
                <a href="{{ route('ca-usages.report')  }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Laporan Pemakaian</span>
                </a>
            </li>
            @endif
            <li>
            ...
            <li>
                <a href="{{ route('stuffs.index')  }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Barang & ATK</span>
                </a>
            </li>
            @if (auth()->user()->role_id === Database\Seeders\RoleSeeder::ADMIN_ID)
            <li>
                <a href="{{ route('stuffs.report')  }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Laporan Barang & ATK</span>
                </a>
            </li>
            @endif
            @if (auth()->user()->role_id === Database\Seeders\RoleSeeder::ADMIN_ID)
...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <h1 class="text-xl font-bold mb-6">@yield('page_title')</h1>
        @yield('admin_content')
    </div>
</div>
